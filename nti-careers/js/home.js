document.addEventListener('DOMContentLoaded', function() {
    ...
    if (searchForm) {
        const searchInputs = searchForm.querySelectorAll('.form-control, .form-select');
    ...
    if (partnersMarquee) {
        ...
        window.addEventListener('scroll', () => {
            ...
            if (scrollSpeed > 5) {
                ...
                partnersMarquee.style.animationDuration = `${baseSpeed * 0.5}s`;
            } else {
                // Normal speed
        ...
        window.addEventListener('scroll', () => {
            ...
            if (Math.abs(currentScrollY - lastScrollY) > 50) {
                tracks.forEach((track, index) => {
                    ...
                    const newDuration = scrollDirection > 0 ? currentDuration * 0.8 : currentDuration * 1.2;
